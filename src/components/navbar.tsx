    ...
    <>
      ...
      >
        ...
        <div className="flex flex-row items-center justify-between py-6 border-b-2 border-b-gray dk-safe-x-padding">
          <Link className="z-50 flex items-center h-10 lg:h-[50px]" href="/" onClick={closeMenu} prefetch={false}>
            <span className="text-2xl font-bold font-montserrat dk-gradient-text">
              Kamlesh.
            </span>
          </Link>
          {/* desktop menu */}
