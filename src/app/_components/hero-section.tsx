    ...
    >
      ...
      <div className="grid grid-flow-row gap-10 xl:grid-cols-2 xl:grid-flow-col xl:gap-0">
        <div className="flex flex-col items-center justify-center order-2 xl:items-start xl:order-1">
          ...
          <div className="mb-6 flex justify-center xl:justify-start w-full">
            <BlurText
              text={CONFIG.role}
              delay={150}
              animateBy="words"
              direction="top"
              className="font-montserrat font-extrabold text-5xl md:text-[64px] md:leading-14 lg:text-[66px] lg:leading-[88px] dk-gradient-text text-center xl:text-left"
            />
          </div>
          <MotionWrapper
            as="p"
